...
function single_post_share($url, $title, $img_url)
{
    ...
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share Facebook Link").'" class="facebook" href="'.$fb_url.'" ><i class="fab fa-facebook-f"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share Twitter Link").'" class="twitter" href="' . $twitter_share_link . '"><i class="fab fa-twitter"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share Linkedin Link").'" class="linkedin" href="' . $linkedin_share_link . '"><i class="fab fa-linkedin-in"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share Pinterest Link").'" class="pinterest" href="' . $pinterest_share_link . '"><i class="fab fa-pinterest-p"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share Whatsupp Link").'" class="whatsapp" target="_blank" href="' . $whatsapp_share_link . '"><i class="fab fa-whatsapp"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share Telegram  Link").'" class="telegram" target="_blank" href="' . $telegram_share_link . '"><i class="fab fa-telegram"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share In Email").'" class="envelope" target="_blank" href="' . $mail_link . '"><i class="far fa-envelope"></i></a></li>';
    ...
    // $output .= '<li><a data-toggle="tooltip" title="'.__("Share Line Link").'" class="line" target="_blank" href="' . $line_share_link . '"><i class="fab fa-line"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Write SMS").'" class="sms" target="_blank" href="' . $message_share_link . '"><i class="fas fa-sms"></i></a></li>';
    $output .= '<li><a data-toggle="tooltip" title="'.__("Share").'" class="pocket" target="_blank" href="' . $pocket_share_link . '"><i class="fab fa-get-pocket"></i></a></li>';
...
function render_payment_gateway_for_form($cash_on_delivery = false)
{
    ...
    $all_gateway = [
        'paypal', 'manual_payment', 'mollie', 'paytm', 'stripe', 'razorpay', 'flutterwave', 'paystack','midtrans',
        'payfast','cashfree','instamojo','marcadopago','squareup','cinetpay','paytabs','billplz','zitopay',
        'toyyibpay','pagali','sitesway','authorizenet', 'senangpay', 'iyzipay', 'awdpay'
    ];
    $output .= '<ul>';
    if ($cash_on_delivery) {
...
function get_exchange_rate($for = 'USD'){
    $global_currency = get_static_option('site_global_currency');
    $currency_filed_name = get_static_option('site_' . strtolower($global_currency) . '_to_usd_exchange_rate');
    switch($for){
        case('INR'):
            return get_static_option('site_' . strtolower($global_currency) . '_to_inr_exchange_rate');
            break;
        case('IDR'):
            return get_static_option('site_' . strtolower($global_currency) . '_to_idr_exchange_rate');
            break;
        case('NGN'):
            return get_static_option('site_' . strtolower($global_currency) . '_to_ngn_exchange_rate');
            break;
        case('ZAR'):
            return get_static_option('site_' . strtolower($global_currency) . '_to_zar_exchange_rate');
            break;
        case('BRL'):
            return get_static_option('site_' . strtolower($global_currency) . '_to_brl_exchange_rate');
            break;
        case('MYR'):
            return get_static_option('site_' . strtolower($global_currency) . '_to_myr_exchange_rate');
            break;
        default: 
...
function getSlugByPageId($pageId) {
    return Page::find($pageId)?->slug;
}

function getPageContentByPageId($pageId) {
    return Page::find($pageId)?->page_content;
}
