            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="widget-area">
                        ...
                        <?php if(!empty(get_static_option('event_page_qr_code_show_hide'))): ?>
                            <div class="widget event-info">
                                <h4 class="widget-title"><?php echo e(get_static_option('event_page_qr_code_title') ?? __('QR code')); ?></h4>
                                <div class="content">
                                    <?php echo $qr_code; ?>

                                    <br>
                                    <div class="btn-wrapper mt-3">
                                        <a href="<?php echo e(route('frontend.events.qrcode.download', $event->slug)); ?>" class="boxed-btn btn-sm reverse-color"><?php echo e(__('Download')); ?></a>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucp\@core\resources\views/frontend/events/event-single.blade.php ENDPATH**/ ?>