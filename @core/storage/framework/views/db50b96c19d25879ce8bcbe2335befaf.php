                    ...
                    <li class="main_dropdown <?php if(request()->is(['admin-home/donations/*','admin-home/donations'])): ?> active <?php endif; ?> ">
                        ...
                        <ul class="collapse">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('donation-withdraw-list')): ?>
                                ...
                                <li class="<?php echo e(active_menu('admin-home/donations/withdraw/payment/gateway')); ?>"><a
                                            href="<?php echo e(route('admin.all.donation.withdraw.payment.gateway')); ?>"><?php echo e(__('Withdraw Payment Gateways')); ?></a>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\ucp\@core\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>