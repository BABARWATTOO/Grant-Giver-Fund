                        ...
                        <form action="<?php echo e(route('admin.events.new')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <label for="terms_and_conditions"><?php echo e(__('Terms & Conditions')); ?></label>
                                        <textarea name="terms_and_conditions"  class="form-control" rows="5" id="terms_and_conditions"></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="privacy_policy"><?php echo e(__('Privacy Policy')); ?></label>
                                        <textarea name="privacy_policy"  class="form-control" rows="5" id="privacy_policy"></textarea>
                                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucp\@core\resources\views/backend/events/new-event.blade.php ENDPATH**/ ?>