...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.success.story.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edit-icon','data' => ['url' => route('admin.success.story.edit',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                            <?php if (isset($component)) { $__componentOriginalb2c1dd794879015d9606d5936970d3cc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb2c1dd794879015d9606d5936970d3cc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clone-icon','data' => ['action' => route('admin.success.story.clone'),'id' => $data->id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb2c1dd794879015d9606d5936970d3cc)): ?>
<?php $attributes = $__attributesOriginalb2c1dd794879015d9606d5936970d3cc; ?>
<?php unset($__attributesOriginalb2c1dd794879015d9606d5936970d3cc); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb2c1dd794879015d9606d5936970d3cc)): ?>
<?php $component = $__componentOriginalb2c1dd794879015d9606d5936970d3cc; ?>
<?php unset($__componentOriginalb2c1dd794879015d9606d5936970d3cc); ?>
<?php endif; ?>
                                           <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.view-icon','data' => ['url' => route('frontend.success.story.single', $data->slug)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action-js','data' => ['url' => route('admin.success.story.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucp\@core\resources\views/backend/pages/success-story/index.blade.php ENDPATH**/ ?>