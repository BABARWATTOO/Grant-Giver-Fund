            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.home.six.about.us.area')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div>
                                <div class="form-group">
                                    <label><?php echo e(__('Title')); ?></label>
                                    <input type="text" name="home_page_06_about_us_area_title" class="form-control"
                                           value="<?php echo e(get_static_option('home_page_06_about_us_area_title')); ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="data" class="form-control" name="home_page_06_about_us_area_description">
                                        <?php echo get_static_option('home_page_06_about_us_area_description'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="home_page_06_about_us_area_button_text" class="form-control"
                                           value="<?php echo e(get_static_option('home_page_06_about_us_area_button_text')); ?>">
                                </div>

                                <div class="form-group">
                                    <label><?php echo e(__(' Button URL')); ?></label>
                                    <input type="text" name="home_page_06_about_us_area_button_url" class="form-control"
                                           value="<?php echo e(get_static_option('home_page_06_about_us_area_button_url')); ?>">
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucp\@core\resources\views/backend/pages/home/home-06/aboutus-area.blade.php ENDPATH**/ ?>