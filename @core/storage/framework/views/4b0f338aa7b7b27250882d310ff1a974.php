                         ...
                         <?php echo csrf_field(); ?>
                            ...
                            <div class="tab_section mb-4">
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <?php if(!empty($donation->monthly_donation_status)): ?>
                            ...
                            <div id="termsAndConditions">
                                <label>
                                    ...
                                    <?php echo e(__('I agree to the')); ?> <a href="<?php echo e(route('frontend.dynamic.page',[getSlugByPageId(get_static_option('donation_terms_and_conditions')), get_static_option('donation_terms_and_conditions')])); ?>" target="_blank"><?php echo e(__('terms and conditions')); ?>

                                    </a> <?php echo e(__('and')); ?>

                                    <a href="<?php echo e(route('frontend.dynamic.page',[getSlugByPageId(get_static_option('donation_privacy_policy')), get_static_option('donation_privacy_policy')])); ?>" target="_blank"><?php echo e(__('privacy policy')); ?></a>
                                </label>
                            </div>
                            <?php endif; ?>
                ...
                <div class="col-lg-4">
                    <div class="donation-amount-details-wrapper">
                        ...
                        <ul>
                            ...
                            <?php if(empty(get_static_option('donation_charge_form')) || get_static_option('donation_charge_form') === 'donor' && !empty(get_static_option('donation_charge_active_deactive_button')) ): ?>
                                <li>
                                    <span><?php echo e(get_static_option('site_title')); ?> <?php echo e(__('tip')); ?></span>
                                    <span class="price admin_tip">
                                        <?php if(!empty(get_static_option('allow_user_to_add_custom_tip_in_donation'))): ?>
                                            <span class="input-wrap">
                                                <input type="number" name="custom_admin_tip" min="1" value="<?php echo e(\App\Helpers\DonationHelpers::get_donation_charge($selected_amount ?? $default_donation_amount)); ?>">
                                            </span>
                                        <?php else: ?>
                                           <span class="amount">
                                               <?php echo e(\App\Helpers\DonationHelpers::get_donation_charge($selected_amount ?? $default_donation_amount,true)); ?>
                            ...
                            <?php if(get_static_option('transaction_minimum_charge_amount') != 0 && get_static_option('transaction_minimum_charge_amount') != null): ?>
                                <li>
                                    <span><?php echo e(__('Transaction Fee')); ?></span>
                                    <span class="price">
                                       <span class="amount transaction_fee_amount">
                                           <?php echo e(\App\Helpers\DonationHelpers::get_transaction_fee($selected_amount ?? $default_donation_amount,true)); ?>
                ...
                function updateDonationAmount(){
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            parent.find('.transaction_fee_amount').text(data.transaction_fee_amount);
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ucp\@core\resources\views/frontend/donations/donation-payment-separate-page.blade.php ENDPATH**/ ?>